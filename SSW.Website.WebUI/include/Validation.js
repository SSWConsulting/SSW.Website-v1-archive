function checkEmail(emailAddr) {
	...
	// DH - 28/02/2003
	// Ignore Suffix. To many to worry about.
	return true;
...
{
 var isMatch = email.match("^([\w\d\-\.]+)@{1}(([\w\d\-]{1,67})|([\w\d\-]+\.[\w\d\-]{1,67}))\.(([a-zA-Z\d]{2,4})(\.[a-zA-Z\d]{2})?)$");
if(isMatch == null)
{return false;}
else
{return true;} 
...
function ValidateForm(eForm)
{
		...
		{
		window.location.href = "http://www.google.com.au/search?q=site%3Assw.com.au%2Fssw%2Fkb+" + eForm.searchFor.value;
				return false;
		}
}