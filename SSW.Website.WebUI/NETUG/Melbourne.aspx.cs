...
{
    public class Melbourne : System.Web.UI.Page
    {
        ...
        private JArray GetCachedEventsResponse(DateTime endDateBefore)
        {
            ...
            var key = $"Melbourne_usergroups_{endDateBefore:yyyy-MM-dd}";
        ...
        private JArray GetCurrentEvents(DateTime endDateBefore)
        {
            ...
            var oDataFilter = $"$filter=Enabled ne false and EndDateTime ge datetime'{dateFilter}' and CalendarType eq 'User Groups' and (City eq 'Online' or City eq 'Melbourne')"
