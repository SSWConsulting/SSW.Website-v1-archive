<%@ Page Language="c#" AutoEventWireup="true" MasterPageFile="~/Masters/RavenSubPage.master" Inherits="SSW.WebUI.NETUG.Canberra" Title="SSW - Canberra's .NET User Group &#8211; covering .NET development, Azure, Power Platform, general DevOps and ALM strategies, Angular, React, Blazor, and MAUI" CodeBehind="Canberra.aspx.cs"%>
...
<script type="application/ld+json">
    {
      ...
      "@type": "Event",
      "name": "Canberra .NET User Group",
      "location": {
        "@type": "Place",
        "name": "Microsoft Canberra",
        "address": {
          "@type": "PostalAddress",
          "streetAddress": "Level 4, 6 National Circuit",
      ...
      "image": [
        "https://www.ssw.com.au/ssw/NETUG/Images/thumbs/thumb-canberraUG.jpg"
       ],
      "description": "The best meetup to learn development for free in Canberra",
      "organizer": {
        "@type": "User Group",
        "name": "SSW Consulting",
...
<asp:Content ID="Content1" ContentPlaceHolderID="title" runat="server">
    ...
    <img alt="Canberra UG" src="Images/thumbs/thumb-UG.jpg" class="icon" />
    <h1>Canberra .NET User Group</h1>
...
<asp:Content ID="Content3" ContentPlaceHolderID="index" runat="server">
    ...
    <ul>
        ...
        <li><a href="#session">Session Details</a></li>
...
<asp:Content ID="Content4" ContentPlaceHolderID="maincontent" runat="server">
    ...
    <div class="section">
        <h3>Canberra .NET User Group - The best meetup to learn .NET for free in Canberra</h3>
    ...
    <div class="section">
        ...
        <table class="normal">
            <tbody>
                ...
                <tr>
                    <td>5min</td>
                    <td>Retro (the good and bad) as per <a href="https://www.ssw.com.au/rules/do-you-know-what-happens-at-a-sprint-retrospective-meeting">Do you know what happens at a Sprint Retrospective Meeting?</a></td>
                </tr>
            </tbody>
        </table>
    ...
    <div class="section">
        ...
        <ul>
            ...
            <li>Your session may be recorded by the guys from <a href="http://tv.ssw.com/" target="_blank">SSW TV</a> straight from the projector cable. Very simpler for presenters</li>
        </ul>

        <p>
            If you think you're up for the challenge and have something new to show us please
            contact <a href="javascript:sendEmail('6164616d636f67616e407373772e636f6d2e6175','I Want To Present At The Canberra User Group')"
    ...
    <div class="section">
        ...
        <p>The User Group is organized by Adam Cogan. He also presents the news at the start of the session, and is the man to speak to about presenting. He also organizes the <a href="https://www.ssw.com.au/ssw/NETUG/Sydney.aspx" target="_blank">Sydney .NET User Group</a>. He can be contacted at <a href="/ssw/Company/ContactUs.aspx">SSW</a> on +61 2 <strong>9953 3000</strong>, by mobile on <strong>04 1985 1995 </strong>- or by <a href="javascript:sendEmail('6164616d636f67616e407373772e636f6d2e6175')" onmouseover="javascript:displayStatus('6164616d636f67616e407373772e636f6d2e6175'); return true;" onmouseout="javascript:clearStatus(); return true;">email</a>.</p>
    </div>
    ...
    <div class="section">
        ...
        <div class="NETUGdownload">
            ...
            <p>
                ...
                Join our <a href="/ssw/Redirect/SSWFaceBookGroupCanberra.htm" class="ignore">Canberra UG Facebook</a>
            </p>
            <p>and</p>
            <p>
                <img src="/ssw/NETUG/Images/linkedin_icon.png" alt="LinkedIn" />
                Join our <a href="/ssw/Redirect/SSWLinkedInGroup.htm" class=" ignore">Canberra UG LinkedIn</a>
            </p>
            <p>and</p>
            <p>
                <img src="/ssw/NETUG/Images/meetup-icon.png" alt="Meetup" />
                Join our <a href="http://www.meetup.com/Canberra-NET-User-Group/" target="_blank" class=" ignore">Canberra UG Meetup</a>
            </p>
...
<asp:Content ID="Content5" ContentPlaceHolderID="sidebarcontainer" runat="server">
    ...
    <div class="section">
        ...
        <h4>
            <img src="/ssw/NETUG/Images/meetup-icon.png" alt="Meetup" />
            Join our <a href="http://www.meetup.com/Sydney-NET-User-Group/" target="_blank" class="ignore">Meetup</a>
        </h4>
    </div>
    <br />
    <br />
    ...
    <div class="section">
        ...
        <p>View <a href="http://www.adamcogan.com/">Adam Cogan's</a> blog.</p>
    </div>
    <br />
    <br />
