<%@ Page Language="c#" AutoEventWireup="true" MasterPageFile="~/Masters/RavenSubPage.master" Inherits="SSW.WebUI.NETUG.Brisbane" Title="SSW - Brisbane Full Stack User Group | .NET development, Azure, Power Platform, general DevOps and ALM strategies, Angular, React, Blazor, and MAUI" CodeBehind="Brisbane.aspx.cs"%>
...
<asp:Content ID="Content1" ContentPlaceHolderID="title" runat="server">
	<img alt="Brisbane UG" src="Images/thumbs/thumb-UG.jpg" class="icon" />
    <h1>Brisbane Full Stack User Group</h1>
...
<script type="application/ld+json">
    {
      ...
      "image": [
        "https://www.ssw.com.au/ssw/NETUG/Images/thumbs/thumb-brisbaneUG.jpg"
       ],
      "description": "The best meetup to learn development for free in Brisbane",
      "organizer": {
        "@type": "User Group",
        "name": "SSW Consulting",
...
<asp:Content ID="Content4" ContentPlaceHolderID="maincontent" runat="server">
    ...
    <div class="section">
        <h3>Brisbane Full Stack User Group - The best meetup to learn development for free in Brisbane</h3>
    ...
    <a name="upcoming"></a>
        ...
        <p><a href="/Live">Join our Sydney User Group live</a>. The live kicks off at 6:30pm.</p>
        <p class="indent">
            <a href="/Live">
        ...
        <h2>When</h2><a name="when"></a> 
            <p>We meet on the 2nd Tuesday of every month from 6:00pm to 8:30pm.</p>

        <h2>Where</h2><a name="where"></a>
            <h3>SSW Brisbane</h3>
            <p class="address">
                Level 1<br />
                471 Adelaide Street<br />
                Brisbane, QLD 4000<br />
                Australia
            </p>
        <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d14160.812042129375!2d153.0321197!3d-27.4629385!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0xd087bdb9527dfca5!2sSSW+Brisbane!5e0!3m2!1sen!2sca!4v1519924413306" width="600" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
    </div>

    <div class="section">
       <h2>Why - 3 Great Reasons to Attend the Full Stack User Group</h2><a name="why"></a>
        <ul class="benefits">
            <li>Learn</li>
    ...
    <div class="section">
        ...
        <table class="normal">
            <tbody>
                ...
                <tr><td>20min</td><td>News</td></tr>
                <tr><td>90min</td><td><strong>Session</strong></td></tr>
                <tr><td>5min</td><td>Retro (the good and bad) as per <a href="https://www.ssw.com.au/rules/do-you-know-what-happens-at-a-sprint-retrospective-meeting">Do you know what happens at a Sprint Retrospective Meeting?</a></td></tr>
            </tbody>
        </table>
    </div>
    ...
    <div class="section">
        ...
        <p>Most speakers present in all cities - <strong>Melbourne</strong>, <strong>Brisbane</strong>, <strong>Brisbane</strong> and last is <strong>Sydney</strong> which is live streamed the recording is posted on <a href="http://tv.ssw.com" target="_blank">tv.ssw.com</a> a couple of days later.</p>
        ...
        <ul>
            ...
            <li>Your session may be recorded by the guys from <a href="http://tv.ssw.com/" target="_blank">SSW TV</a> straight from the projector cable. Very simple for presenters</li>
        </ul>
        
        <p>
            If you think you're up for the challenge and have something new to show us please
            contact <a href="javascript:sendEmail('6164616d636f67616e407373772e636f6d2e6175','I Want To Present At The Brisbane User Group')"
                onmouseover="javascript:displayStatus('6164616d636f67616e407373772e636f6d2e6175'); return true;"
                onmouseout="javascript:clearStatus(); return true;">SSW</a>.</p>
    </div>
    
    <div class="section">
        <h2>Who Organizes It?</h2>
        <p>The User Group is organized by <a href="https://www.ssw.com.au/people/jason-taylor">Jason Taylor</a>, <a href="https://www.ssw.com.au/people/luke-parker">Luke Parker</a>, and <a href="https://www.ssw.com.au/people/bryden-oliver/">Bryden Oliver</a>. They also present the news at the start of the session, and are the ones to speak to about presenting. They can be contacted at <a href="/ssw/Company/ContactUs.aspx">SSW</a> on + 61 07 <strong>3077 7081</strong>.</p>
    </div>
    ...
    <div class="section">
        ...
        <p>Subscribe to our newsletter to receive updates!</p>
            ...
            <p>
                ...
                Join our <a href="https://www.meetup.com/Brisbane-Full-Stack-User-Group/" target="_blank" class=" ignore">Brisbane UG Meetup</a></p>
				<p>and</p>
				<img src="Images/facebook_icon.png" alt="Facebook" />
                Join our <a href="https://www.facebook.com/groups/BNEFullStackUG/" class="ignore">Brisbane UG Facebook</a></p>
                        <p>and</p>
            <p>
                <img src="/ssw/NETUG/Images/linkedin_icon.png" alt="LinkedIn" />
                Join our <a href="https://www.linkedin.com/groups/13583436" class=" ignore">Brisbane UG LinkedIn</a></p>
...
<asp:Content ID="Content5" ContentPlaceHolderID="sidebarcontainer" runat="server">
    ...
    <div class="section">
                <h4>
            <img src="/ssw/NETUG/Images/meetup-icon.png" alt="Meetup" />
            Join our <a href="https://www.meetup.com/Brisbane-Full-Stack-User-Group/" target="_blank" class="ignore">Meetup</a>
        </h4>
		<h4>
            <img src="Images/facebook_icon.png" alt="Facebook" />
            Join our <a href="https://www.facebook.com/groups/BNEFullStackUG/" class="ignore">Facebook</a>
        </h4>
		<h4>
            <img src="/ssw/NETUG/Images/linkedin_icon.png" alt="LinkedIn" />
            Join our <a href="https://www.linkedin.com/groups/13583436" class="ignore">LinkedIn</a>
        </h4> 
    </div>
    <br /><br />
