<%@ Page Language="c#" AutoEventWireup="false" MasterPageFile="~/Masters/Pigeon.master" Title="Backblaze and CloudBerry Backup | SSW Consulting - Sydney, Brisbane, Melbourne" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeaderScripts" runat="server">
    ...
    <meta property="og:image:alt" content="SSW Backblaze and CloudBerry Backup Consulting - Enterprise Software Development" />
    <meta property="og:title" name="title" content="SSW Backblaze and CloudBerry Backup Consulting - Enterprise Software Development">
    <meta property="og:description" content="More often than not businesses take their data and data protection for granted. It is an easy oversite when your business is running smoothly and quickly."/>
</asp:Content>
...
<asp:Content ID="Content6" ContentPlaceHolderID="MainBody" runat="server">
    ...
    <div class="Consulting-Hero employement-video">
        ...
        <div class="container hero">
            <h1>Need help with your <span class="red">Cloud Backup with Backblaze and CloudBerry Lab</span>?</h1>
	...
	<div class="benefits-section MVC-benefits-background">
		<div class="container"><a name="more"></a>
            <h5>More often than not businesses take their data and data protection for granted. It is an easy oversite when your business is running smoothly and quickly. Loss of large amounts of data can cause a business to struggle to recover and in a lot of cases shut down completely.</h5>
            <h5>Backblaze has introduced a simple backup system utilizing B2 Cloud Storage which is cheap, requires little on premises infrastructure and fast to setup.</h5>
            ...
            <div class="row">
                ...
                <div class="col-md-6 benefitsBox speedUpBx PBI aos-init aos-animate" data-aos="fade-left">
                    ...
                    <h4>BACKUP</h4>
                    <p>Design and implement a backup solution that covers all mission critical applications and files.</p>
                </div>
            </div>
            <div class="row">
	...
	<div class="technologies-section">
		<div class="container">
            ...
            <div class="col-md-6">
                <div class="greyTBox aos-init" data-aos="flip-right">
	...
	<div class="solution-section">
		<div class="container">
            <h1>Talk to us about your <span class="red">Cloud Backup Plan</span></h1>
