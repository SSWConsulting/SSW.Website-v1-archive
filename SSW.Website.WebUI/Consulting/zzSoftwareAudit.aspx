	...
	<div class="benefits-section MVC-benefits-background">
		<div class="container"><a name="more"></a>
            ...
            <h5>
                ...
                <i class="fa fa-check"></i> <strong>nsuring your team remains agile and adaptable to change</strong>
            </h5>
            ...
            <div class="row">
                ...
                <div class="col-md-6 benefitsBox fasterAccessBx" data-aos="fade-right">
                    ...
                    </br>· Requirements Analysis document containing plans and recommendations
                    </br>· A list of product backlog items (PBIs) 
                    </br>· Ballpark Estimates for the cost of the project and number of sprints to complete.
                    </p>
            ...
            <div class="row">
               ...
               <div class="row">
                ...
                <div class="col-md-6 benefitsBox fasterAccessBx" data-aos="fade-right">
                    ...
                    </br>· Running penetration tests with SSL labs to check how exposed your servers are.
                    </br>· Passwords in .config and code
                    </br>· Authentication an Authorization
                    </br>· Cross site scripting and SQL injection
                    </br>· Encryption of passwords and sensitive data.
                    </br>· Audit trails and logging
                    </p>
                </div>
            </div>
