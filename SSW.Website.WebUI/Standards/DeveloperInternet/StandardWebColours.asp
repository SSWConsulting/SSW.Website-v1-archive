...
<% '#1 Above 2 lines required by SSWWebTemplate.aspx ver 1 %>
...
<Link rel="stylesheet" type="text/css" href="/ssw/Include/ssw.css">
...
<TABLE WIDTH="100%" BGCOLOR=white BORDER=0 CELLSPACING=0 CELLPADDING=0>
  <TR> 
    <TD><IMG src="/ssw/Images/SSWsmall.gif" alt="SSW" name=Image1 ><IMG height=45 src="/ssw/Images/hd_2.gif" alt="SSW" width=200 ></TD>
  </TR>
</TABLE>
