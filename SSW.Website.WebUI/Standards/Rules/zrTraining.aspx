...
<p>        
    ...
    <div class="greyBox floatRight" style="width: 35%;">
        ...
        <p>
            View our <a href="/ssw/Products/ProdCategoryList.aspx?GroupCategoryID=7DEVT">training
                prices</a> or <a href="/ssw/company/ContactUs.aspx">contact us</a> for further
            information.
        </p>
    </div>
    <div id="intro">
    ...
    <div class="TableOfContents">
        ...
        <ol>
            <li><a href="#ShowYourData">The best ways to show your data</a>&nbsp; <span style="color: #ff0000">
                <b>*New*</b></span></li>
            ...
            <li><a href="#ReportingServices2005">What's new in Reporting Services 2005 + Developing
                Custom Report Items</a>&nbsp; <span style="color: #ff0000"><b>*New*</b></span></li>
        ...
        <ol>
            <li><a href="#TeamSystem">Visual Studio 2005 Team System - An Overview</a> <span
                style="color: #ff0000"><b>*New*</b></span></li>
            <li><a href="#TeamSystemDrilling">Visual Studio 2005 Team System - Drilling into Work
                Items and Customization</a> <span style="color: #ff0000"><b>*New*</b></span></li>
            <li><a href="#ExtendingCheckPoliciesVSTS">Visual Studio 2005 Team System - Extending
                Check in Policies</a>&nbsp; <span style="color: #ff0000"><b>*New*</b></span></li>
            <li><a href="#DataBindingASP2">Data Binding in ASP .NET 2.0</a> <span style="color: #ff0000">
                <b>*New*</b></span></li>
            <li><a href="#FavouriteThirdPartyToolsTFS">Favourite Third Party Tools for Team Foundation
                Server (TFS) and Visual Studio Team System (VSTS)</a>&nbsp; <span style="color: #ff0000">
                    <b>*New*</b></span></li>
        ...
        <ol>
            ...
            <li><a href="#HealthyCode">15 Rules to Better Code + Tools to Keep your Code Healthy
                (including FX Cop)</a> <span style="color: #ff0000"><b>*New*</b></span></li>
        ...
        <ol>
            ...
            <li><a href="#XMLNTier" class="strike">Utilising XML as the Solution for n-Tier Development</a></li>
    ...
    <ol>
        ...
        <li><a name="WindowsAppsVBNET"></a>
            ...
            <ul>
                ...
                <li>How to utilise a UDL and connection strings</li>
        ...
        <li><a name="ExpWeb"></a>
            ...
            <p>
                <a target="_blank" href="http://www.ssw.com.au/ssw/Redirect/SSWUpdate/2007Jan/TristanProfile.htm">
...
--%>
        <li><a name="CSSBestPrac"></a>
            ...
            <p>
                Sick of style saturation? <a target="_blank" href="http://www.ssw.com.au/ssw/Redirect/SSWUpdate/2007Jan/TristanProfile.htm">
    ...
    <ol>
        ...
        <li><a name="SQLServer2000"></a>
            ...
            <ul>
                ...
                <li>Utilise SP Mail as the most powerful work-horse in your application</li>
    ...
    <span class="strike">
        <ol>
            ...
            <li><a name="XMLNTier"></a>
                <h2>
                    Utilising XML as the Solution for n-Tier Development
                </h2>
                <p>
                    This session will highlight and detail how and where XML can be utilised within
            ...
            <li><a name="AdvancedADO"></a>
                ...
                <ul>
                    ...
                    <li>Utilising prepared statements</li>
