...
<P><img alt="" src="/ssw/Methodology/Images/DataSchemaStandard_AddSolutionToSourceControl.gif" width="216" height="361"></P>
...
<P>Now, at this stage the 
	database schema will be reasonably stable (ie there are no planned major 
	developments.)</P>
...
<P><img src="Images/GenerateScript.gif" alt="" width="395" height="290"> 
<img src="/ssw/Methodology/Images/GenerateScriptVS.gif" alt="" width="286" height="246"></P>
...
<P><strong>Make sure the correct options are selected (this 
		...
		projects):</strong></P>
<P><img src="Images/DataSchemaStandard_ScriptingOptions.gif" alt="" width="544" height="417"><BR>
<STRONG>Figure 2: Create Script Standard 
			Settings&nbsp;&nbsp;</STRONG></P>
<P><img src="Images/DataSchemaStandard_ScriptingOptions.gif" alt="" width="544" height="417"><BR>
<STRONG>Figure 3: Create Script Standard Settings&nbsp;<BR>
			&nbsp;<BR>
		</STRONG><img src="Images/DataSchemaStandard_ScriptingOptions.gif" alt="" width="544" height="417"><BR>
...
<P>
<IMG alt="Create it via SQL Server Enterprise Manager" src="Images/saveScript.gif" border="0" width="600" height="320"><BR>
...
<BR>
<BR>
<IMG src="Images/ScriptChange.gif" alt="" border="0" width="456" height="347"><BR>
...
<P><img alt="" src="Images/DirectoryStructure.gif" width="531" height="325" ><img alt="" src="http://www.ssw.com.au/ssw/Methodology/Images\DataSchemaStandard_ScriptsVS.gif"></P>
...
<P><STRONG>Determine the current version and the scripts to be run.</STRONG> You 
	will check the current version of the database e.g. </P>
<STRONG>
...
<P><img alt="" src="http://www.ssw.com.au/ssw/Methodology/Images\DataSchemaStandard_RunScriptOn1VS.gif">
	<img alt="" src="http://www.ssw.com.au/ssw/Methodology/Images\DataSchemaStandard_RunScriptOn2VS.gif" width="238" height="296"></P>
<P>Figure: Running the scripts on the destination servers 
		in VS.NET.</P>
<P><STRONG>Note:<BR>
	</STRONG>There are some important steps you will take before running these 
	change scripts:<BR>
	 <STRONG>1. </STRONG>Ideally, close off users 
		...
		you will not have any other users with locks on the objects you are 
		changing.&nbsp;<BR>
...
<P>
	<TABLE cellSpacing="2" cellPadding="5" width="50%" align="left" border="0">
		<tr>
			<td>
				<p><IMG height="300" alt="" src="Images/SampleTable.gif" width="600"><BR>
					...
					<tr>
						<td borderColor="#ffffff" bgColor="#cccccc">
							...
							<P>Use 
										...
										Insert</a><IMG height="8" alt="You are about to leave the SSW site" src="Images/LeaveSite.gif" width="19">.
									<br>
		...
		<tr>
			<td width="410">
				<P>&nbsp;</P>
				<P><IMG src="/ssw/Images/Validation/SmallRedBall.gif" alt="" width="10" height="10">
				...
				<P>The developer will be in responsible for breaking 
