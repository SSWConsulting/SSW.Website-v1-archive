<%@ Page Language="C#" AutoEventWireup="false" MasterPageFile="~/Masters/RavenSubPage.master" Title="Enterprise MVC Apps Day I: MVC Foundations: From the Ground Up" %>
<%--Do not change the title - we know it's long, but for SEO purposes--%>

<asp:Content ID="HeaderContent" ContentPlaceHolderID="HeaderScripts" runat="server">
    <meta name="description" content="Day 1 of a Complete overview of building enterprise MVC applications using ASP.NET <http://ASP.NET> MVC 4, including architecture best practices, data planning and UI implementation guildelines" />
</asp:Content>
...
<asp:Content ContentPlaceHolderID="title" runat="server">
        ...
        <h1>Enterprise MVC Apps Day I</h1>
        <h2>MVC Foundations: From the Ground Up</h2>
</asp:Content>

<asp:Content ID="Content3" ContentPlaceHolderID="index" runat="server"> 
<%--    <h2>MVC Apps Day I:</h2>
    <ul>
...
<asp:Content ID="Content1" ContentPlaceHolderID="maincontent" runat="server">
    ...
    <h2><a name="Description"></a>Description</h2>
        ...
        <p>We know a developer who is really frustrated with MVC.</p>
        <p>His name is John and he has been trying to build an enterprise MVC app for months now. The problem is he is not getting any closer. He has spent countless hours searching Google (uh..um Bing) but has had no luck. </p>
        <p>He can find countless code samples, that all seem to be written specifically to show off the latest and greatest features, but nothing that represents trying to build a real world application from the ground up.</p>
        <p>Well we decided to do something to help John and hopefully you.</p>
        <p>We have been building Enterprise MVC apps for years now and we want to teach you how to do it the right way.</p>
        <p>Forget the simplistic self-contained code samples you are probably looking at now. We are going to show you exactly how we build enterprise MVC applications at SSW.</p>

    <h2><a name="WhatYouWilllearn"></a>What you'll learn</h2>
    <p>This course will introduce you to the latest version of ASP.NET MVC; version 4.  By the end of the course, attendees will know:</p>
    <ul>
        <li><b>How MVC works</b> - We'll take a peek under the covers of ASP.NET MVC 4 to discover how it works</li>
        <li><b>User Interface Considerations</b> - We'll look at how to get a clean, useable and responsive user interface with minimal stress</li>
        <li><b>Targeting Mobile Devices</b> - Once you know how, building MVC sites that look great on mobile devices is easy</li>
    </ul>

    <h2><a name="CourseOutline"></a>Course Outline</h2>
    <h3 class="accordionHeader">Section 1 - Intro to MVC</h3>
        <ul>
            <li>Model-View-Controller</li>
            <li>How ASP .NET MVC Works</li>
            <li>Why choose MVC?</li>
            <li>Controllers</li>
            <li>Views and View Models</li>
        </ul>
    
    <h3 class="accordionHeader">Section 2 - Working with Data</h3>
        <ul>
            <li>Models</li>
            <li>Data Access</li>
            <li>Edit Forms and Templating</li>
            <li>Validation</li>
        </ul>

    <h3 class="accordionHeader">Section 3 - Making it pretty</h3>
        <ul>
            <li>Using Kendo UI and JQuery for a responsive user interface</li>
            <li>Using Twitter Bootstrap for page layouts</li>
        </ul>
    
    <h3 class="accordionHeader">Section 4 - Tips and Tricks</h3>
    <ul>
        <li>Glimpse and other useful NuGet Packages</li>
    </ul>
    
    <h3 class="accordionHeader">Section 5 - Mobile Targeting</h3>
    <ul>
    ...
    <h2><a name="Bonus"></a>Bonus</h2>
        ...
        <ul class="good">
            <li><b>Book 2 courses:</b> JustCode + 1 x <a href="http://www.telerik.com/products/mocking.aspx" target="_blank">JustMock</a> (valued $648)</li>
            <li><b>Book 3 courses:</b> JustCode, JustMock and 1 x <a href="http://www.kendoui.com/web.aspx" target="_blank">KendoUI Web</a> (valued $1,047)</li>
            <li><b>Book 4 courses:</b> JustCode, JustMock, KendoUI Web, and 1 x <a href="http://www.telerik.com/products/memory-performance-profiler.aspx" target="_blank">JustTrace</a> (valued $1,446)</li>
        </ul>
    ...
    <h2><a name="TargetAudience"></a>Target Audience</h2>
        ...
        <ul>
            <li>ASP .NET developers looking to jump on the MVC bandwagon</li>
        </ul>
