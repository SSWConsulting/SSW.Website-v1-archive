...
<asp:Content ID="Content7" ContentPlaceHolderID="asideleft" runat="server">
    ...
    <hr style="margin: 0" />
        <ul id="filters">
            <li><a href="Default.aspx">View current events</a></li>
        </ul>
    <br />
    <br />
    ...
    <div class="section offer hidden-xs">
        <div class="onsite">
           <p><a href="https://vimeo.com/ondemand/sswazure" target="_blank"><img src="Images/AzureOnDemand.png" alt="AzureOnDemand" class="center" /></a></p>
        </div>
    </div>
    <div class="rounded hidden-xs">
...
<div class="eventfilters" style="height: 0px; padding: 0px; float: right">
    ...
    <div class="section eventsection">
        <div id="ongoingEventsHeader" class="event-item isotope-header isotope-item" >
                <h3 class="red">Past Events <span class="count"></span> - <a href="Default.aspx">View current events</a></h3>
        </div>
        <div id="item-current">
