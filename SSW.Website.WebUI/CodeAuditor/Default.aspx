<%@ Page Language="C#" MasterPageFile="~/Masters/RavenSubpage.master" Title="SSW CodeAuditor - Utility to automate your code reviews" %>
...
<asp:Content ContentPlaceHolderID="sidebarcontainer" runat="server">
    ...
    <img src="images/productBox_CodeAuditor.gif" alt="CodeAuditor product box" style="margin-bottom:10px;" />

    <!-- <div class="download">
        <p><a href="https://marketplace.visualstudio.com/items?itemName=DanijelMalik.SSWCodeAuditor2017" class="green next ignore btn">Free Download</a></p>
        <p><a href="/ssw/Products/ProdCategory.aspx?CategoryID=CODAUD" class="red next btn">Go PRO</a></p>
        <p><a href="/ssw/Download/ProdBasket.aspx?ID=CA">Purchase PRO</a></p>
    </div>-->
    ...
    <div class="section">
        <ul>
            ...
            <li><a href="https://github.com/SSWConsulting/SSW.CodeAuditor/discussions" target="_blank">Submit an idea</a></li>
        </ul>
     </div>
    <br /><br />
    <div class="rounded">
    ...
    <div>
        <a class="twitter-timeline ignore" href="https://twitter.com/hashtag/codeauditor" data-widget-id="639152844134817792">#codeauditor Tweets</a>
        <script>!function (d, s, id) { var js, fjs = d.getElementsByTagName(s)[0], p = /^http:/.test(d.location) ? 'http' : 'https'; if (!d.getElementById(id)) { js = d.createElement(s); js.id = id; js.src = p + "://platform.twitter.com/widgets.js"; fjs.parentNode.insertBefore(js, fjs); } }(document, "script", "twitter-wjs");</script>
    </div>

    <div class="fb-page" data-href="https://www.facebook.com/CodeAuditor" data-tabs="timeline" data-height="300" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true"><div class="fb-xfbml-parse-ignore"><blockquote cite="https://www.facebook.com/CodeAuditor"><a href="https://www.facebook.com/CodeAuditor">SSW CodeAuditor</a></blockquote></div></div>
...
<asp:Content ContentPlaceHolderID="title" runat="server">
    <img src="images/codeauditor-logo.png" alt="CodeAuditor logo" />
...
<asp:Content ID="Content1" ContentPlaceHolderID="maincontent" runat="server">
    <div id="productInfo" class="section">
        ...
        <h2>Are you looking to eradicate bugs and ensure consistency?</h2>
            <p>SSW CodeAuditor is a code analysis tool that allows developers to take control of your code, ensuring large, complex source code can be simplified, cleaned and maintained. The built-in rules focus on the most popular .NET languages (C#, VB.NET) for both Windows Forms and ASP.NET; however, the flexibility of SSW CodeAuditor allows the developer to add their own rules to target any language in any text file.</p>
            ...
            <p>Here at SSW, we face the problem of maintaining our standards across nearly five thousand web pages, over twenty active projects in both Visual Basic (6 and .NET) and C#. There comes a point where a tool to check our work is needed, this tool is SSW CodeAuditor.</p>
            <p>SSW CodeAuditor utilizes the power of Regular Expressions and the new Roslyn compiler to audit your code. This powerful feature permits the user to write their own set of rules and have different rules for different projects.</p>
            ...
            <table class="normal">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            <dl class="image">
                                <dt><a href="images/fromca.png" class="lightbox image" rel="gallery"><img src="images/fromvs.png" style="max-width:300px;" alt="Start Visual Studio to use SSW CodeAuditor - VS Extension"/></a></dt>
                                <dd>Figure: Step 2 - Start Visual Studio 2010, 2012, 2013 or 2015</dd>
                            </dl>
                        </td>
                        <td>
                            <dl class="image">
                                <dt><a href="images/fromvs.png" class="lightbox image" rel="gallery"><img src="images/fromca.png" style="max-width:300px;" alt="Launch SSW CodeAuditor from the start menu and audit your code!"/></a></dt>
                                <dd>Figure: Step 2 - Launch SSW CodeAuditor</dd>
                            </dl>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <dl class="image">
                                <dt><a href="images/extension.png" class="lightbox image" rel="gallery"><img src="Images/extension.png" style="max-width:300px;" alt="SSW CodeAuditor - VS Extension toolbar" /></a></dt>
        ...
        <h2>Key Features & Benefits</h2>
            <p>SSW CodeAuditor allows you to:</p>
            <ul>
            ...
            <table border="0" cellspacing="0" class="tblScreenshots normal">
                <tr>
                    <td width="100">
                        <a href="images/Thickbox/SSWCodeAuditorStartThickbox.jpg" title="Figure: Run SSW CodeAuditor" class="lightbox image" rel="gallery"><img src="images/Thickbox/SSWCodeAuditorStartSmall.jpg" alt="Screen Shot"/></a>
                    </td>
                    <td valign="top">
                ...
                <tr>
                    ...
                    <td valign="top">
                        <strong>Stay on top of things.</strong> CodeAuditor has in-built scheduling and email notification functionality so you can have regular reminders of what needs attention in your projects!
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    ...
                    <td valign="top">
                        <strong>Report Output.</strong> <a href="SampleReport_Good.xml">See a sample good report</a> from the CodeAuditor process.<br/>
                        <a href="SampleReport_Bad.xml">See a sample bad report</a> from the CodeAuditor process.
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td valign="top">
                        <strong>Visual Studio Team Foundation Server Add-in.</strong> Automatically adds an additional Check-in policy that runs SSW CodeAuditor and stops developers from check in code that violates rules.<br/>
        ...
        <h2>More Technical Features</h2>
            <p>CodeAuditor includes the ability to:</p>
            <ul>
                <li>Scan TFS Pending changes (Only if using VS 2012 or later)</li>
                ...
                <li>Use new Roslyn compiler & syntax tree for more explicit rules</li>
                <li>Helpful template for writing Roslyn rules</li>
            </ul>
        ...
        <h2>Upcoming Features</h2>
            <ul>
                ...
                <li>Right click on a project and "Scan with CodeAuditor" (auto detect type of project)</li>
        ...
        <h2><a name="Rules"></a>Predefined Rules - examples of rules you can define</h2>
            <p><a href="/ssw/Standards/Rules/RulesToBetterSSWProducts.aspx">Do they go in CodeAuditor or Link Auditor?</a></p>
        ...
        <h2>How to show your application is 'SSW CodeAuditor' Compliant?</h2>
            <p>To show your users that you have taken the care to create a 'healthy' code, you may display this image on any web pages and applications that are validated by CodeAuditor.</p>
            <img src="Images/codeauditorcompliant.gif" alt="CodeAuditor Compliant icon" />
            <p>Here is the HTML to add this icon to your web page:</p>
            <div class="code">
&lt;a href="http://www.ssw.com.au/ssw/CodeAuditor"&gt;
&lt;img src="/ssw/Images/codeauditorcompliant.gif" alt="CodeAuditor compliant" /&gt;&lt;/a&gt;
            </div>
    ...
    <div class="section greybox">
        ...
        <p>SSW CodeAuditor is similar to <a href="/ssw/Redirect/MSFxCop.htm" target="_blank">Microsoft FxCop</a> but has some important differences.</p>
        <ul>
            ...
            <li>CodeAuditor has a lot of rules - none of which are in FxCop, eg. the rules listed on our <a href="http://rules.ssw.com.au/Pages/default.aspx">Rules To Better pages</a>...</li>
            <li>FxCop works against compiled assemblies only (it uses MSIL to get information about the code). SSW CodeAuditor on the other hand looks at the source code itself. This means you can worry about the code formatting and comments.</li>
            <li>FxCop only works against .NET assemblies. SSW CodeAuditor on the other hand works against any plain text files. So now you can write any rules against any files in the solution.</li>
            <li>Overall <a href="/ssw/Redirect/AllFxCopRules.htm">FxCop rules</a> are good - however many are obscure (Eg. we do not worry about the <a href="/ssw/Redirect/FxCopGlobalizationRules.htm"> Globalization rules</a>, <a href="/ssw/Redirect/FxCopMobilityRules.htm">Mobility rules</a> and <a href="/ssw/Redirect/FxCopPortabilityRules.htm">Portability rules</a>). SSW CodeAuditor on the other hand has rules that are more 'general developer' oriented.</li>
            <li>In addition SSW CodeAuditor provides many rules to improve your User Interface.</li>
            <li>For most users <a href="/ssw/Redirect/MSDNMagBugslayer.htm">FxCop rules are fixed</a> (unless you want to build a .NET Assembly). SSW CodeAuditor rules can easily be extended using regular expressions.</li>
            <li>Out of the box FxCop only provides one type of <a href="/ssw/HealthAuditor/FxCopTutorial.aspx#FxCopReport"> report in xml</a>. SSW CodeAuditor on the other hand provides a report that is flexible and shows the data in different views.</li>
            <li>Both can be scheduled via a command line. SSW CodeAuditor's <a href="UserGuide.aspx#Schedule">wizard</a> makes it real easy to help you keep your code projects clean all the time.</li>
            <li>SSW CodeAuditor includes a VS.NET Extension, which encourages you to use both within the <a href="/ssw/HealthAuditor/UserGuide.aspx">VS.NET environment</a>.</li>
            <li>SSW CodeAuditor now supports custom rules written in the new Roslyn compiler (used for C# and VB)</li>
        </ul>
    </div>
