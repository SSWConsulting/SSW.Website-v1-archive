<%
	Function GetDownloadURL
		...
		strDownloadID = Request.QueryString("DownloadID")
		...
		' Check Connection to the database could be made
		if cnn.State <> 1 Then
			GetDownloadURL = "/SSW/Download"
			Exit Function
		End If
		...
		Dim strSQL
		strSQL = "SELECT FileNameURL " _
			+ "FROM Download " _
			+ "WHERE DownloadID = '" + strDownloadID + "'"
