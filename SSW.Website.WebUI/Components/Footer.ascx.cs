	...
	partial class Footer : System.Web.UI.UserControl
	{
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
			if (!IsPostBack) {
				...
				// Continious Deployment details
				lthContDeployment.Text = "Last deployment to " + Environment.MachineName;
				try {
					...
					lthContDeployment.Text += ". Unable to retrieve changeset details.";
